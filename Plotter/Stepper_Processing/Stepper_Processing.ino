//This code is to recieve data via serial from a processing sketch.
...
void X_forward() {   
   ...
   digitalWrite(Enable_X, HIGH);            //Enable the y-axis.
...
//    delay(10*pause);                       //A small amount of time here allows for the shaft to move over.
//    digitalWrite(StepperA1, LOW);
//    delay(100*pause); 
//    break;
//    
...
//    digitalWrite(StepperB1, LOW);
//    delay(100*pause); 
//    X_Count = 0;                             //Set Button_Count back to zero to start over.
//    break;
//   }
...
void new_line(){
 ...
 //  Y_Count++;                               //Add one to button count for switch/case.
...
////    delay(10*pause);                          
////    digitalWrite(StepperB1, LOW);
////    Y_Count = 0;                       //Set Button_Count back to zero to start over.
//    break;
//   
//    }
...
void back_to_zero(){
 ...
 // digitalWrite(Enable_Y, HIGH);
  ...
  for(int i=0; i<15; i++)//4 steps per iteration 15 times = the horizontal resolution of the image(60).
  {
    digitalWrite(StepperB1, HIGH); 
    delay(pause); 
    digitalWrite(StepperB1, LOW); 
